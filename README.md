...
This uses a rope data structure from the [xi-editor](https://github.com/google/xi-editor/) project.  Since that module is not yet published indpendently, a copy of the crate is in [rope](rope).
